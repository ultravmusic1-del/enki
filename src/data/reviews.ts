 ...
 *
 * Deliberately carries no `helpful` count or `verified` flag: Enki cannot
 * substantiate either, and inventing engagement metrics for a monetized review
 * site is what 16 CFR Part 465 prohibits.
 */
